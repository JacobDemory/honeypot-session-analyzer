...
# RFC 5737 documentation-only addresses are used in the public version.
# Replace these values in a private deployment configuration when operating
# the project in an authorized lab environment.
CONTAINERS["DESKTOP-1AJRJA"]="192.0.2.11";
CONTAINERS["DESKTOP-2AJRJA"]="192.0.2.12";
CONTAINERS["DESKTOP-3AJRJA"]="192.0.2.13";
CONTAINERS["DESKTOP-4AJRJA"]="192.0.2.14";
CONTAINERS["DESKTOP-5AJRJA"]="192.0.2.15";
CONTAINERS["DESKTOP-6AJRJA"]="192.0.2.16";
